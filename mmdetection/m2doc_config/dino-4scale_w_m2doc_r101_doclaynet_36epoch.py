...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file=
        'data/doclaynet/COCO/train.json',
        ann_prefix = 'data/doclaynet/Annos/',
        data_prefix = dict(img='data/doclaynet/PNG'),
...
work_dir = 'mmdetection/work_dirs/dino-4scale_w_m2doc_r101_8xb2-12e_doclaynet'